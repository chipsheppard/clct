		...
		<div class="callout">
			...
			<div class="col-1-2">
				...
				if ( $link ) :
					...
					?>
					<a href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>" class="btn alt"><?php echo esc_html( $link_title ); ?></a>
				<?php endif; ?>
			</div>
			<div class="cf"></div>
		</div><!-- /callout -->
	...
	<div class="message">
		<div class="inner-wrap">
			...
			<div class="message-image">
				...
				<?php if ( $caption ) : ?>
					<div class="message-image-caption"><?php echo esc_html( $caption ); ?></div>
				<?php endif; ?>
			</div>
		</div>
	</div><!-- /message -->
